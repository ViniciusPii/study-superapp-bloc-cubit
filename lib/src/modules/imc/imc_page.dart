...
class _ImcPageState extends State<ImcPage> {
  ...
  Widget _buildResult() {
    return StreamBuilder<ImcState>(
      stream: bloc.imcStateStream,
      initialData: ImcInitial(),
      builder: (context, snapshot) {
        return Visibility(
          visible: snapshot.data is ImcSuccess,
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Text(
                'Seu imc é ${snapshot.data!.imc.toStringAsFixed(1)}',
      ...
      child: Column(
        children: [
          ...
          StreamBuilder<ImcState>(
            ...
            builder: (context, snapshot) {
              return Visibility(
                visible: snapshot.data is ImcLoading,
